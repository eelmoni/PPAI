        ...
        do {
            ...
            switch (opc) {
                ...
                case 4://fecha estimada inscripcion, fecha estimada realizacion
                    ...
                    do {
                        if (a == 2) {
                            System.out.println("Alguna o ambas de las fechas ingresadas son anteriores al dia de hoy,o la fecha de realizacion es anterior a la de inscripicon porfavor ingrese las fechas nuevamente: ");
                        }
